...
filename = "./plotting/h2_modes_"+str(int(ReTest))+".csv"
np.savetxt(filename, modal_coeffs, delimiter=",")
    
with open("./plotting/h2_field_"+str(int(ReTest))+".csv", 'w') as outfile:
...
#plot_data_allmodes(t,at[:,:],aTest,'modes_2d.pdf')#,aGP1[-1,:,:])
